...
function renderBar(id, bands, color) {
    ...
    STATE.charts[id] = new Chart(document.getElementById(id).getContext('2d'), {
        type:'bar',
        data:{ labels:Object.keys(bands).map(k=>k.toUpperCase()),
...
function renderScatter(id, matrix) {
    ...
    STATE.charts[id] = new Chart(document.getElementById(id).getContext('2d'), {
        type:'scatter',
        data:{datasets:[{label:'Latency (ms)',
        ...
        pointRadius:5}]},
        options:chartOpts('Timestamp (s)','Latency (ms)'),
    });
}
...
function renderSync(id, sync) {
    ...
    STATE.charts[id] = new Chart(document.getElementById(id).getContext('2d'), {
        ...
        options:{responsive:true,animation:{duration:300},
            ...
            scales:{
                x:{title:{display:true,text:'Time (s)',color:'#333'},ticks:{color:'#333',font:{family:'monospace',size:9},maxTicksLimit:8},grid:{color:'#111'}},
                y:{title:{display:true,text:'Onset',color:'#333'},ticks:{color:'#333',font:{family:'monospace',size:9}},grid:{color:'#111'},max:1.2},
            }},
    });
}
...
function chartOpts(xL,yL) {
    return {
        ...
        plugins:{legend:{labels:{color:'#444',font:{family:'monospace',size:10}}}},
        scales:{
            x:{title:{display:true,text:xL,color:'#333'},ticks:{color:'#333',font:{family:'monospace',size:9},maxTicksLimit:8},grid:{color:'#111'}},
            y:{title:{display:true,text:yL,color:'#333'},ticks:{color:'#333',font:{family:'monospace',size:9}},grid:{color:'#111'}},
        }
    };
}
